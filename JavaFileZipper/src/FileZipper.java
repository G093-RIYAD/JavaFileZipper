        ...
        for (int i = 7; i >= 0; i--) {
            ...
            if (bit == 0) {
                if (current != null && current.left != null) {
                    ...
                    // Handle the case where current or current.left is null
                    break;
                }
            } else {
                if (current != null && current.right != null) {
                    ...
                    // Handle the case where current or current.right is null
                    break;
                }
            }
